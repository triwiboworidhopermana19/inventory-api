...
namespace Illuminate\Support\Facades {
    ...
    use Illuminate\Log\Logger;use Illuminate\Log\LogManager;use Illuminate\Mail\Mailer;use Illuminate\Mail\MailManager;use Illuminate\Mail\PendingMail;use Illuminate\Mail\SentMessage;use Illuminate\Notifications\ChannelManager;use Illuminate\Queue\QueueManager;use Illuminate\Queue\SyncQueue;use Illuminate\Routing\Exceptions\BackedEnumCaseNotFoundException;
